...
namespace Switch_From_Switch.Problem_Set.Problem_2
{
    ...
    /// </summary>
    public class Problem2Expansion
    {
        ...
        {
            Problem2.LoopOverMenuOptions(Problem2Expansion.staticMenuGameOptions);

            int choice = 0;
            Problem2.GetValidUserChoice(Problem2Expansion.staticMenuGameOptions, ref choice);

            Problem2Expansion.staticMenuGameOptions[choice-1].menuMethod.Invoke();
        }    
        ...
        {
            Problem2Expansion instance = new Problem2Expansion();
            Problem2.LoopOverMenuOptions(instance.instanceMenuGameOptions);

            int choice = 0;
            Problem2.GetValidUserChoice(instance.instanceMenuGameOptions, ref choice);
