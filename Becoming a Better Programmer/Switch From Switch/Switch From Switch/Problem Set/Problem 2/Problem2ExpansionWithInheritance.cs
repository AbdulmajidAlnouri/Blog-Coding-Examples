...
namespace Switch_From_Switch.Problem_Set.Problem_2
{
    ...
    /// </summary>
    public class Problem2ExpansionWithInheritance : Problem2
    {
        ...
        /// </summary>
        public Problem2ExpansionWithInheritance():base()
        {            
        }
        ...
        {
            LoopOverMenuOptions(Problem2ExpansionWithInheritance.staticMenuGameOptions);

            int choice = 0;
            GetValidUserChoice(Problem2ExpansionWithInheritance.staticMenuGameOptions, ref choice);

            Problem2ExpansionWithInheritance.staticMenuGameOptions[choice-1].menuMethod.Invoke();
        }
        ...
        {
            Problem2ExpansionWithInheritance instance = new Problem2ExpansionWithInheritance();
