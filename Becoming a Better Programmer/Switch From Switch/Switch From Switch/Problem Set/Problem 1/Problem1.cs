...
namespace Switch_From_Switch.Problem_Set.Problem_1
{
    ...
    public class Problem1
    {
        ...
        {
            LoopOverMenuOptions(Problem1.staticMenuGameOptions);

            int choice = 0;
            GetValidUserChoice(Problem1.staticMenuGameOptions, ref choice);

            Problem1.staticMenuGameOptions[choice-1].menuMethod.Invoke();
        }
